...
5. `build/entrypoint.sh` orchestrates the integration flow: initialize MySQL, clone target project, export WAR using Servoy `war_export.sh`, deploy to Tomcat, then health-check the app.
